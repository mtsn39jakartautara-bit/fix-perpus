// resources/js/Pages/Admin/ClassPromotion/ClassPromotion.tsx
...
import SingleClassPromotion from "./components/SingleClassPromotion";
import MultipleClassPromotion from "./components/MultipleClassPromotion";
...
export default function ClassPromotion({ classes, activeAcademicYear }: Props) {
            ...
            <div className="space-y-6">
                ...
                <div className="rounded-2xl bg-gradient-to-r from-primary to-primary-glow p-6 text-white">
                    ...
                    <p className="mt-2 opacity-90">
                        Pindahkan siswa ke kelas yang lebih tinggi secara manual
                        atau import dari file Excel
                    </p>
                    {activeAcademicYear && (
                    ...
                    <CardContent className="p-0">
                        ...
                        >
                            ...
                            <TabsContent value="single" className="p-6">
                                <SingleClassPromotion classes={classes} />
                            </TabsContent>

                            <TabsContent value="multiple" className="p-6">
                                <MultipleClassPromotion classes={classes} />
                            </TabsContent>
                        </Tabs>
                    </CardContent>
                </Card>
