// resources/js/Pages/Admin/Uploads/components/MultipleStudentUpload.tsx
...
export default function MultipleStudentUpload({
    classes,
    academicYears,
    activeAcademicYear,
}: Props) {
    ...
    const handlePreview = async (e: React.FormEvent) => {
        ...
        if (!classId) {
            setErrors({ class_id: "Silakan pilih kelas" });
            return;
        }

        if (!academicYearId) {
            setErrors({ academic_year_id: "Silakan pilih tahun ajaran" });
            return;
        }
        ...
        formData.append("academic_year_id", academicYearId as string);

        try {
            const response = await axios.post(
                route("admin.students.preview"),
                formData
            );
    ...
    const handleConfirmImport = () => {
        ...
        router.post(route("admin.students.multiple"), formData, {
            onSuccess: () => {
                setFile(null);
                ...
                toast.success("Data siswa berhasil diupload");
            },
            onError: (err) => {
                setErrors(err);
                setIsConfirming(false);
                toast.error("Data siswa gagal diupload");
            },
        });
    };
        ...
        <>
            <form onSubmit={handlePreview} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-xs text-primary">
                                    💡 Email akan otomatis dibuat dari NIS:
                                    student.[NIS]@mtsn39.com
                                </p>
                            </div>
                            <Button
                                type="button"
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            value={academicYearId as string}
                            onValueChange={(value) => {
                                setAcademicYearId(value);
                                if (errors.academic_year_id) setErrors({});
                            }}
                        >
                            <SelectTrigger
                                className={
                    ...
                    <AlertDescription>
                        <div className="space-y-1 text-sm">
                            ...
                            <ul className="list-inside list-disc space-y-1 pl-2">
                                ...
                                <li>
                                    Kolom NAMA, NIS, dan JENIS_KELAMIN wajib
                                    diisi
                                </li>
                                <li>
                                ...
                                <li>Password siswa akan menggunakan NIS</li>
                                <li>NIS harus unik (belum terdaftar)</li>
                                <li>
                                    Semua siswa akan di-enroll ke kelas yang
                                    dipilih
                                </li>
                            </ul>
                        </div>
            ...
            <Dialog open={showPreview} onOpenChange={setShowPreview}>
                <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Preview Data Siswa</DialogTitle>
                        <DialogDescription>
                            Review data siswa sebelum diimport. Pastikan semua
                            data sudah benar.
                        </DialogDescription>
                    </DialogHeader>
