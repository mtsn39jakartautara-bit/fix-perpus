// resources/js/Pages/Admin/Uploads/components/MultipleTeacherUpload.tsx
...
export default function MultipleTeacherUpload() {
    ...
    const handleDownloadTemplate = () => {
        window.location.href = route("admin.teachers.template");
    };
    ...
    const handleConfirmImport = () => {
        ...
        router.post(route("admin.teachers.multiple"), formData, {
            onSuccess: () => {
                setFile(null);
                ...
                toast.success("Data guru berhasil diupload");
            },
            onError: (err) => {
                setErrors(err);
                setIsConfirming(false);
                toast.error("Data guru gagal diupload");
            },
        });
    };
        ...
        <>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-xs text-primary">
                                    💡 Email akan otomatis dibuat dari NIP:
                                    teacher.[NIP]@mtsn39.com
                                </p>
                            </div>
                            <Button
                                type="button"
                    ...
                    <AlertDescription>
                        <div className="space-y-1 text-sm">
                            ...
                            <ul className="list-inside list-disc space-y-1 pl-2">
                                ...
                                <li>
                                    Kolom NAMA, NIP, dan MATA_PELAJARAN wajib
                                    diisi
                                </li>
                                <li>
                                ...
                                <li>Password guru akan menggunakan NIP</li>
                                <li>NIP harus unik (belum terdaftar)</li>
                            </ul>
                        </div>
                    </AlertDescription>
                </Alert>
            ...
            <Dialog open={showPreview} onOpenChange={setShowPreview}>
                <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Preview Data Guru</DialogTitle>
                        <DialogDescription>
                            Review data guru sebelum diimport. Pastikan semua
                            data sudah benar.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    {/* Duplicate NIP Warning */}
                    {previewSummary.duplicate_nip.length > 0 && (
                        <Alert className="bg-red-50 border-red-200">
                            <AlertDescription>
                                <p className="font-semibold text-red-800">
                                    ⚠️ Peringatan: Duplikasi NIP dalam file!
                                </p>
                                <p className="text-sm text-red-700 mt-1">
                                    NIP berikut muncul lebih dari satu kali
                                    dalam file:{" "}
                                    {previewSummary.duplicate_nip.join(", ")}
                                </p>
                                <p className="text-sm text-red-600 mt-1">
                                    Harap perbaiki file Anda karena NIP harus
                                    unik.
                                </p>
                            </AlertDescription>
                        </Alert>
