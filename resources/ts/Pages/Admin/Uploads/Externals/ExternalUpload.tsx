// resources/js/Pages/Admin/Uploads/Externals/ExternalUpload.tsx
...
import SingleExternalForm from "../components/SingleExternalForm";
import MultipleExternalUpload from "../components/MultipleExternalUpload";
...
export default function ExternalUpload() {
    ...
    return (
        <AdminLayout>
            <Head title="Tambah Pengguna Eksternal" />

            <div className="space-y-6">
                {/* Header */}
                <div className="rounded-2xl bg-gradient-to-r from-primary to-primary-glow p-6 text-white">
                    <h1 className="text-2xl font-bold">
                        Tambah Data Pengguna Eksternal
                    </h1>
                    <p className="mt-2 opacity-90">
                        Tambah pengguna eksternal baru secara manual atau import
                        dari file Excel
                    </p>
                </div>
