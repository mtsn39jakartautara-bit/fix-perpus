...
export default function DigitalBookEdit({ book, categories }: Props) {
    const [formData, setFormData] = useState({
        ...
        pdf_file: null as File | "delete" | null,
    });
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route("admin.books.digital.update", book.id), data, {
            onSuccess: () => {
                setLoading(false);
            },
            onError: (err) => {
            ...
            <div className="mx-auto max-w-4xl px-5 pt-8 lg:px-10 lg:pt-10">
                ...
                >
                    ...
                    <div className="rounded-3xl bg-card p-6 shadow-soft">
                        ...
                        <div className="space-y-4">
                            {/* Existing PDF File */}
                            {book.pdf_file && !formData.pdf_file && (
                            ...
                            >
                                ...
                                />
                                {formData.pdf_file &&
                                formData.pdf_file !== "delete" ? (
                                    <>
                                        <FileText className="h-12 w-12 text-primary" />
                                        <p className="mt-2 text-sm font-medium text-primary">
                                            {(formData.pdf_file as File).name}
                                        </p>
                                        <p className="text-xs text-muted-foreground">
                                            {(
                                                (formData.pdf_file as File)
                                                    .size /
                                                1024 /
                                                1024
                                            ).toFixed(2)}{" "}
