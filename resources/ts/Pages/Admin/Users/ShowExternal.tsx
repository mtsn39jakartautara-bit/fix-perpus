...
export default function ShowExternal({ user, borrowings, visits }: Props) {
            ...
            <div className="mx-auto max-w-7xl px-5 pt-8 lg:px-10 lg:pt-10">
                ...
                >
                    <div className="flex items-center gap-4">
                        <Link
                            href={route("admin.users.external")}
                        ...
                        <div className="flex items-center gap-2">
                            <div className="w-10 h-10 rounded-2xl bg-primary flex items-center justify-center shadow-lg">
                                <Users2Icon className="w-5 h-5 text-white" />
                            </div>
                            <div>
                                <h1 className="text-2xl font-bold tracking-tight lg:text-3xl">
                                    Detail Pengguna Eksternal
                                </h1>
                                <p className="text-sm text-muted-foreground mt-1">
                                    Informasi lengkap data pengguna eksternal
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="rounded-3xl bg-card shadow-soft overflow-hidden sticky top-8">
                            ...
                            <div className="bg-gradient-to-r from-primary/20 to-primary/10 p-6 text-center">
                                ...
                                <div className="mt-2 flex flex-wrap items-center justify-center gap-2">
                                    ...
                                    {/* Toggle Barcode Button */}
                                    {user.barcode && (
                                        <button
                                            onClick={() =>
                                                setShowBarcode(!showBarcode)
                                            }
                                            className="inline-flex items-center gap-1 rounded-full bg-muted px-2 py-1 text-xs font-medium text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all"
                                        >
                                            {showBarcode ? (
                                                <>
                                                    <Users2Icon className="h-3 w-3" />
                            ...
                            <div className="p-6 space-y-4">
                                <div className="space-y-3">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-start gap-3 text-sm">
                                            <IdCardIcon className="h-4 w-4 text-muted-foreground mt-0.5" />
                                            <div>
                                                <p className="text-muted-foreground">
                                                    NIK
                                                </p>
