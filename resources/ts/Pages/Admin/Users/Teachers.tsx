            ...
            <div className="mx-auto max-w-7xl px-5 pt-8 lg:px-10 lg:pt-10">
                    ...
                    <div className="rounded-3xl bg-card p-6 shadow-soft">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-3xl font-bold text-blue-600">
                                {
                                    users.data.filter((u) => u.teacher?.subject)
                                        .length
                                }
                            </span>
                        </div>
                    ...
                    <div className="rounded-3xl bg-card p-6 shadow-soft">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-3xl font-bold text-green-600">
                                {
                                    users.data.filter((u) => u.teacher?.phone)
                                        .length
                                }
                            </span>
                        </div>
                        ...
                        <div className="flex flex-1 gap-3">
                            <div className="relative flex-1">
                                ...
                                <input
                                    ...
                                    placeholder="Cari guru berdasarkan nama, email, NIP, atau mata pelajaran..."
                ...
                {users.data.length > 0 ? (
                    ...
                    >
                        {users.data.map((user) =>
                            viewMode === "grid" ? (
                                <TeacherCardGrid key={user.id} user={user} />
                            ) : (
                                <TeacherCardList key={user.id} user={user} />
                            )
                        )}
                    </motion.div>
                ) : (
...
// Grid Card Component for Teacher
function TeacherCardGrid({ user }: { user: User }) {
    return (
            ...
            <div className="relative overflow-hidden rounded-3xl bg-card shadow-soft transition-all hover:-translate-y-1 hover:shadow-lg">
                <div className="p-5">
                    ...
                    <div className="mt-4 pt-3 border-t border-border flex items-center justify-between">
                        ...
                        <Link
                            href={route("admin.users.show.teacher", user.id)}
...
// List Card Component for Teacher
function TeacherCardList({ user }: { user: User }) {
    return (
        <motion.div variants={fade} className="group">
