                            ...
                            <div className="flex-1">
                                ...
                                <p className="mt-1 text-sm text-white/85">
                                    ...
                                    {role === "student"
                                        ? "di kelas"
                                        : "di sekolah"}{" "}
                                    minggu ini. Tukar dengan reward menarik di
                                    toko poin.
                                </p>
                                ...
                                <div className="mt-4 max-w-md">
                                    <div className="flex justify-between text-xs mb-1">
                                        ...
                                        <span>
                                            {pointsToNext.toLocaleString()} poin
                                            lagi
                                        </span>
                                    </div>
                        ...
                        <div className="flex items-center justify-between px-6 py-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Berdasarkan total poin yang terkumpul
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                `}
                                    ...
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            Ajak teman-teman untuk mengumpulkan
                                            poin!
                                        </p>
                                    </div>
                                )}
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-green-800">
                                                    🎉 Selamat! Anda masuk dalam
                                                    Top 10 siswa
                                                </p>
                                                <p className="text-xs text-green-600 mt-0.5">
                                                    Pertahankan prestasi Anda
                                                    dan kumpulkan lebih banyak
                                                    poin!
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div className="space-y-2">
                                ...
                                `}
                                    ...
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            Ajak rekan guru untuk mengumpulkan
                                            poin!
                                        </p>
                                    </div>
                                )}
